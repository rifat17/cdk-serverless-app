...
(or `python` for Windows) executable in path with access to the `venv`
...
them to `setup.py` file and rerun the `pip install -r requirements.txt`
command.
